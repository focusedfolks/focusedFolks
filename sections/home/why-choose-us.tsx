  ...
  return (
    <section className="py-16 md:py-24">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeader
          badge="Why FocusFolks"
          title="Premium delivery for mission-critical outcomes"
          description="A proven enterprise process—designed to keep stakeholders aligned, timelines predictable, and quality uncompromising."
          align="left"
          servicesPage
        />
        ...
        <div className="services-benefits-masonry">
          {whyChooseUs.map((item, idx) => (
            ...
            >
              <div
                className="why-us-card-shine relative overflow-hidden rounded-3xl border border-white/12 bg-slate-950/45 p-6 shadow-[inset_0_1px_0_rgba(255,255,255,0.08),0_20px_50px_rgba(0,0,0,0.35)] backdrop-blur-xl transition-transform duration-300 hover:-translate-y-1 sm:p-7"
                style={{ "--shine-delay": `${idx * 0.9}s` } as React.CSSProperties}
              >
                <div
                ...
                <div className="relative z-[2]">
                  <motion.div
                    className="flex h-[4.5rem] w-[4.5rem] shrink-0 items-center justify-center rounded-2xl border border-cyan-400/20 bg-gradient-to-br from-blue-500/30 to-cyan-500/15 shadow-[0_8px_32px_rgba(34,211,238,0.15)]"
